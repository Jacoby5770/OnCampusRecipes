...
(deftest handle-message-test
  (testing "the integration and handling of messages"
    (let [ehdlrs (merge
      ...
      (is (= "recipe has been added: paella."
             (<!! (handle-message
                    system
                    "jacoby"
                    "recipe paella 30 30 spanish"))))
      (is (= "recipe has been added: lasagna."
             (<!! (handle-message
                    system
                    "jacoby"
                    "recipe lasagna 20 15 italian"))))
      (is (= "recipe has been added: cassarole."
             (<!! (handle-message
                    system
                    "jacoby"
                    "recipe cassarole 10 5 french"))))
      (is (= "recipe has been added: meatloaf."
             (<!! (handle-message
                    system
                    "jacoby"
                    "recipe meatloaf 10 15 southern"))))
      (is (= "recipe has been added: burrito."
             (<!! (handle-message
                    system
                    "jacoby"
                    "recipe burrito 10 10 mexican"))))
      (is (= "paella"
             (<!! (handle-message
                    system
                    "jacoby"
